...
const _BackButton = (props) =>
	<Button type="primary" onClick={ () => props.history.goBack() }>Retour</Button>;
	...
	return (
		<div>
				...
				props.order.items.map((item) => {
					...
					return (
						<div className="cart-prod">
							...
							<div className="cart-prod-prc">{displayCurrency(price)}DA</div>
							...
							<div className="cart-prod-line-prc">{displayCurrency(total)}DA</div>
						</div>
					);
				})
			}
			<div className="cart-prod">
				...
				<div className="cart-prod-line-prc">{displayCurrency(cartTotal.totalPrice)}DA</div>
			</div>
						...
						<div className="form">
							<React.Fragment>
								...
								<div className='form-bottom'>
									...
									<Button onClick={onEditDisable} style={{ marginLeft: '10px' }}>Annuler</Button>
								</div>
								}
							</React.Fragment>
						</div>
